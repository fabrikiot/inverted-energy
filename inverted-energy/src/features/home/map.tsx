export const Map = () => {
  return (
    <div className="w-[65%] h-full px-1 justify-between flex items-center">
      <img src="/public/map.gif" className="h-[98%] w-[65%] pt-1" alt="" />
      <div className="flex flex-col gap-8 w-[35%]  items-center  justify-between">
        <div className="bg-[#3298d8] rounded-xl w-[10vw] h-[11vh] flex flex-col items-center justify-center">
          <span className="text-[24px] font-bold">437</span>
